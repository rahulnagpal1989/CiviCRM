...
class CRM_Membershipperiods_Upgrader_Base {
    ...
    public function onPostProcess($formName, &$form) {
        if (is_callable(array($this, 'postProcess'))) {
    ...
    public function onPost($op, $objectName, $objectId, &$objectRef) {
        if (is_callable(array($this, 'post'))) {
            $this->post($op, $objectName, $objectId, $objectRef);
        }
    }

    public function onbuildForm($formName, &$form) {
        if (is_callable(array($this, 'buildForm'))) {
